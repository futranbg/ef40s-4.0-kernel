...
#define MAX_VDD_MEM		1275000 /* uV */
#define MAX_VDD_DIG		1200000 /* uV */
#else
#define MAX_VDD_SC		1150000 /* uV */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[22] = {1566000,  1, 0x1D, 1200000, 1275000, 5},
#endif
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  { {1, 0},  30000,   ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   750000, 0x03006000},
  /* MAX_AXI row is used to source CPU cores and L2 from the AFAB clock. */
  { {0, 0},  MAX_AXI, ACPU_AFAB,  1, 0, 0, 0,    L2(0),   750000, 0x03006000},
  { {1, 0},  84000,   ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   750000, 0x03006000},
  { {1, 0},  138000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   775000, 0x03006000},
  { {1, 0},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   775000, 0x03006000},
  ...
  { {1, 1}, 1900000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(22), 1250000, 0x03006000},
#endif
  { {0, 0}, 0 },
};
