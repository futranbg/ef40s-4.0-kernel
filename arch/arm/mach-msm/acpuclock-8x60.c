...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[21] = {1512000,  1, 0x1C, 1225000, 1300000, 4},
	[22] = {1566000,  1, 0x1D, 1250000, 1325000, 5},
#endif
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_fast[] = {
  ...
  { {1, 0},  192000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   800000, 0x03006000},
  ...
  { {1, 1}, 1900000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(22), 1350000, 0x03006000},
#endif
  { {0, 0}, 0 },
};
